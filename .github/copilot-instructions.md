            ...
            it('should configure and start adapter', function () {
                return new Promise(async (resolve, reject) => {
                    try {
                        ...
                        // Verify states
                        const stateIds = await harness.dbConnection.getStateIDs('philips-air.0.*');
...
#### Device Testing in CI/CD

For adapters with physical device dependencies:
...
- Run credential/device tests separately from main test suite
...
[CUSTOMIZE: Philips Air Adapter - Specific Coding Standards and Patterns]
...
### Network Error Handling and Connection Recovery
