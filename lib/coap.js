...
const NAME_MAPPING = {
    ...
    mode:        {name: 'mode', options: {'P': 'auto', 'A': 'allergen', 'S': 'sleep', 'M': 'manual', 'B': 'bacteria', 'N': 'night'}, control: true},
...
/*const client = new AirPurifier('192.168.178.84');
client.on('ready', () => {
    console.log('READY');
    client.control({power: false});
});

client.on('status', status => console.log(JSON.stringify(status, null, 2)));*/
